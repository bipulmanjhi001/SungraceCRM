...
public class TechnicianActionTempSpareListAdapter extends BaseAdapter {
    private Context context;
    Activity activity;
    JsonObjectHandler handler;
    TechnicianActionFragment technicianAction;
    FragmentManager fragmentManager;
    SharedPreferences sharedPreferencesAction;
    public ArrayList<Spares> spares = new ArrayList<Spares>();

    TechnicianActionTempSpareListAdapter(TechnicianActionFragment technicianAction,FragmentManager fragmentManager)
    {
    ...
    public View getView(final int position, View convertView, ViewGroup parent){
        final TechnicianActionTempSpareListAdapter.ViewHolderItem holder;
        if (convertView == null) {
            holder = new TechnicianActionTempSpareListAdapter.ViewHolderItem();
        ...
        {
            holder = (TechnicianActionTempSpareListAdapter.ViewHolderItem) convertView.getTag();
        }
            ...
            try {
                if (jsonObject!=null){
                    ...
                    if (statusObject.getBoolean("status")){
                        ...
                        toast.show();
                        technicianAction.adapter.notifyDataSetChanged();
